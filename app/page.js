          ...
          <menu className="mx-4 grid sm:grid-cols-3 md:mx-40 my-8 tall">
            <div className="flex gap-4 justify-center sm:justify-center md:justify-start">
              <div className="cursor-pointer flex flex-col gap-2">
                <div className="active:bg-gray-700 bg-[url('/icons/images/placeholder.png')] bg-gray-900 rounded-md bg-cover bg-center h-44 w-28 flex place-content-center items-center">
